  ...
  mpv =
      ...
      custom_ffmpeg =
        (super.ffmpeg-full.override {
          ...
          src = super.fetchFromGitHub {
            owner = "FFmpeg";
            repo = "FFmpeg";
            rev = "ffa64a4db8ba37face9508caee0cf25efff70c4a";
            sha256 = "02rysdxgz2hl9hsd8gp9mp3x2q5lkigkdkfa5zkhwc93k53m9511";
          };
          version = "9999";
    ...
    in (super.mpv.override {
      ...
      src = super.fetchgit {
        ...
        rev = "51e05056969ad899f69f9ec73976a5f6de54ec5a";
        sha256 = "00dbgc4wvyymi3fg1121xsbza6ylxpmcyc9f417cq1p7ipjc2qm3";
        fetchSubmodules = false;
        leaveDotGit = true;
        deepClone = true;
      };
